...
import { EditarInformacionFinancieraPage } from "../editar-informacion-financiera/EditarInformacionFinancieraPage.js";
import { EditarSeguroPage } from "../editar-seguro/EditarSeguroPage.js";
import { EditarTransitoPage } from "../editar-transito/EditarTransitoPage.js";
  ...
  return (
    <Layout sectionTitle="Unidades" navLinksArr={unidadesLinks[userRol]}>
      <Switch>
        ...
        <Route exact path={`${path}/unidad/:id/editar-info-financiera/:idFinanzas`}>
          <div className="p-3">
          <EditarInformacionFinancieraPage/>
            {/* <p>pagina editar info financiera</p> */}
          </div>
        </Route>
        ...
        <Route exact path={`${path}/unidad/:id/editar-seguro/:idSeguro`}>
          <div className="p-3">
          <EditarSeguroPage/>
            {/* <p>pagina editar seguro</p> */}
          </div>
        </Route>
        ...
        <Route exact path={`${path}/unidad/:id/editar-transito/:idTransito`}>
          <div className="p-3">
          <EditarTransitoPage/>
            {/* <p>pagina editar transito</p> */}
          </div>
        </Route>
