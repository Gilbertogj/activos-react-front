...
export const FormAgregarTransito = ({ unidadId, transitoData }) => {
  ...
  useEffect(() => {
    if (transitoData) {
      setForm({
        placas: transitoData.placas,
        operador: transitoData.operador,
        fecha_vencimiento_licencia: transitoData.fecha_vencimiento_licencia,
        fecha_inicio_operacion: transitoData.fecha_inicio_operacion,
